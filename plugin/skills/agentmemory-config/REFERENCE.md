...
Generated by scanning `src/` for `AGENTMEMORY_*` usage. Do not edit the block below by hand; run `bun run skills:gen` after adding or removing a variable. Internal markers ending in two underscores are excluded.
